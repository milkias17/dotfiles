local c = require("my_theme.palette")
...
theme.set_highlights = function()
	...
	hl(0, "TSNamespace", { fg = c.blue, bg = "NONE" })
	...
	hl(0, "LirSymLink", { fg = c.blue, bg = "NONE" })
	...
	hl(0, "DashboardFooter", { fg = c.blue, bg = "NONE" })
	...
	hl(0, "NavicIconsClass", { fg = c.blue, bg = "NONE" })
	...
	hl(0, "NavicIconsEnum", { fg = c.blue, bg = "NONE" })
	hl(0, "NavicIconsInterface", { fg = c.blue, bg = "NONE" })
	...
	hl(0, "NavicIconsObject", { fg = c.blue, bg = "NONE" })
	...
	hl(0, "NavicIconsStruct", { fg = c.blue, bg = "NONE" })
